...
?>
    <main class="container-fluid mt-4">
        <section class="book-reviews-section">
            <h1 class="text-center text-purple">Movie Reviews</h1>
            <p class="text-center text-light">
                Welcome to the Movie Reviews section. Here, we share insightful reviews of our favorite movies. Explore a variety of genres and find your next great watch!
            </p>
                ...
                <?php if ($auth->isLogged()) {?>
                    <div class="row mt-4">
                        ...
                        if(sizeof($data['favourites']) == 0):
                            {
                                echo '<p class="text-center text-light"> You have no favourite movies!</p>';
                            } else: {
